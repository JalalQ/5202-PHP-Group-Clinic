...
CREATE TABLE `primary_nav` (
  `primary_nav_id` int(20) UNSIGNED NOT NULL,
...
ALTER TABLE `primary_nav`
  ADD PRIMARY KEY (`primary_nav_id`),
...
--
-- AUTO_INCREMENT for table `primary_nav`
--
ALTER TABLE `primary_nav`
  MODIFY `primary_nav_id` int(20) UNSIGNED NOT NULL AUTO_INCREMENT;
COMMIT;
