...
$newAdmin = new AdminAllUsersPDO();
$roles = $newAdmin->getRoles($dbcon);
...
if(isset($_POST['updAdmin'])){
    $id = $_POST['id'];
    $a = $newAdmin->getAdminById($dbcon, $id);
...
if(isset($_POST['updateAdmin'])){
    ...
    if($fname == "" || $lname == "" || $username == "" || $email == "" || $role == ""){
        ...
        $admin = $newAdmin->updateUser($dbcon, $id, $fname, $lname, $username, $email, $role);
...
<div class="d-lg-flex align-items-stretch w-100">
    ...
    <main class="w-100 order-2" id="admin_main">
        <div class="container-fluid mb-5">
            ...
            <div class="card mb-3">
                <h1 class="p-3">Update Administrator</h1>
                ...
                <form action="" method="post" class="p-3">
                    ...
                    <button type="submit" class="btn btn-dark" name="updateAdmin">Update</button>
                </form>

            </div>

            <!--Link to the administrator list page-->
            <a class="sidebar_item" href="index.php?page=admin_admins">Go back to list</a>
