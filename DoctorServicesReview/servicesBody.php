          ...
          <div class="row">
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <img class="card-img-top" src="img/complain.jpg" alt="Complaints, Feedback and Compliment" > <!--style="width:200px;height:200px;"-->
                <div class="card-body">
              ...
              <div class="col-md-4">
                  <div class="card mb-4 box-shadow">
                      <img class="card-img-top" src="img/spiritual.jpg" alt="Spiritual Care" > <!--style="width:200px;height:200px;"-->
                      <div class="card-body">
                          <div class="d-flex justify-content-between align-items-center">
              ...
              <div class="col-md-4">
                  <div class="card mb-4 box-shadow">
                      <img class="card-img-top" src="img/translation.jpg" alt="Interpreter Translation" > <!--style="width:200px;height:200px;"-->
                      <div class="card-body">
                          <div class="d-flex justify-content-between align-items-center">
